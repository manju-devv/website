  ...
  <div class="main-container">
    ...
    <section id="Home" class="home">
      <div class="content-container">
        ...
        <p class="p">Are you ready to start your adventure and start building the next greatest SAAS app on the market?</p>
        <div class="side-rect"></div>
        <a href="#_" class="sign-up">Signup Today!</a>
        <p class="pp">INTEGRATES WITH</p>
        <div class="iconss">
          <svg id="svg" class="h-8 mr-4 text-gray-500 duration-150 cursor-pointer fill-current transition-color hover:text-gray-600" viewBox="0 0 2499 1037" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg id="svg" class="h-8 mr-4 text-gray-500 duration-150 cursor-pointer fill-current transition-color hover:text-gray-600" viewBox="0 0 2350 2315" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg id="svg" class="h-8 mr-4 text-gray-500 duration-150 cursor-pointer fill-current transition-color hover:text-gray-600" viewBox="0 0 2500 2158" xmlns="http://www.w3.org/2000/svg">
            <g stroke="none" stroke-width="1">
          ...
          <svg id="svg" class="h-8 mr-4 text-gray-500 duration-150 cursor-pointer fill-current transition-color hover:text-gray-600" viewBox="0 0 680 680" xmlns="http://www.w3.org/2000/svg">
            <g stroke="none" stroke-width="1">
          ...
          <svg id="last-svg" class="h-8 mr-4 text-gray-500 duration-150 cursor-pointer fill-current transition-color hover:text-gray-600" viewBox="0 0 1681 417" xmlns="http://www.w3.org/2000/svg">
            <g stroke="none" stroke-width="1">
            <g>
      ...
      <div class=main-img>
        <img class="imgg" src="https://cdn.devdojo.com/images/september2020/macbook-mockup.png" alt="computer-icon">
      </div>
    </section>
          ...
          <div class="back-design">
            <div class="contentt">
              <svg class="absolute w-full h-full text-gray-100 fill-current" viewBox="0 0 377 340" xmlns="http://www.w3.org/2000/svg">
                <g>
                <g>
                <path fill="#F7FAFC" d="M342.8 3.7c24.7 14 18.1 75 22.1 124s18.6 85.8 8.7 114.2c-9.9 28.4-44.4 48.3-76.4 62.4-32 14.1-61.6 22.4-95.9 28.9-34.3 6.5-73.3 11.1-95.5-6.2-22.2-17.2-27.6-56.5-47.2-96C38.9 191.4 5 151.5.9 108.2-3.1 64.8 22.7 18 61.8 8.7c39.2-9.2 91.7 19 146 16.6 54.2-2.4 110.3-35.6 135-21.6z"></path>
                </g>
                </g>
              </svg>
              <div class="data">
                <svg id="icons1" class="relative w-20 h-20" viewBox="0 0 58 58" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <defs>
              ...
              <p class="para">Automate your workflow with these top of the line marketing tools.</p>
              <a href="#">Learn More</a>
              </div>
            </div>
            <div class="contentt">
              <svg class="absolute w-full h-full text-gray-100 fill-current" viewBox="0 0 358 372" xmlns="http://www.w3.org/2000/svg">
                  <g>
                      <g>
                          <path fill="#F7FAFC" d="M315.7 6.5c30.2 15.1 42.6 61.8 41.5 102.5-1.1 40.6-15.7 75.2-24.3 114.8-8.7 39.7-11.3 84.3-34.3 107.2-23 22.9-66.3 23.9-114.5 30.7-48.2 6.7-101.3 19.1-123.2-4.1-21.8-23.2-12.5-82.1-21.6-130.2C30.2 179.3 2.6 141.9.7 102c-2-39.9 21.7-82.2 57.4-95.6 35.7-13.5 83.3 2.1 131.2 1.7 47.9-.4 96.1-16.8 126.4-1.6z"></path>
                      </g>
                  </g>
              </svg>
              <div class="data">
              ...
              <p class="para">Your Marketing tools will learn how to better convert and sell.</p>
              <a href="#">Learn More</a>
              </div>
            </div>
            <div class="contentt">
              ...
              <p class="para">Our smart notifications will notify you when users convert.</p>
              <a href="#">Learn More</a>
              </div>
            </div>
          </div>
    ...
    <section id="Pricing">
      ...
      <div class="cards">
        <div class="card1">
          ...
          <p class="description">In our basic plan you can take advantage of all these features below.</p>
          <div class="svg-tick">
            <svg id="tick-icon" class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none" stroke="#48BB78" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="card2">
          ...
          <p class="description">Our most popular package is the Pro Plan which gives you access to the following:</p>
          <div class="svg-tick">
            <svg id="tick-icon" class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none" stroke="#48BB78" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
              <polyline points="22 4 12 14.01 9 11.01"></polyline>
            </svg>
            <p>Really Cool Features</p>
          </div>
          <div class="svg-tick">
            <svg id="tick-icon" class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none" stroke="#48BB78" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
        ...
        <div class="card3">
          ...
          <p class="description">With our premium plan you can take advantage of all the following features:</p>
          <div class="svg-tick">
            <svg id="tick-icon" class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none" stroke="#48BB78" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
              <polyline points="22 4 12 14.01 9 11.01"></polyline>
            </svg>
            <p>Totally Tubular Feature</p>
          </div>
          <div class="svg-tick">
            <svg id="tick-icon" class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none" stroke="#48BB78" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
...
.main-img {
  display: flex;
  position: relative; /* Position image container relative to section */
  flex: 0 0 auto; /* Prevent resizing */
  right: 0; /* Align to the right */
  height: 90vh; /* Keep image height proportional */
  max-width: 100%; 
}
...
.card1 h4,p,.card2 h4,p,h5,.card3 h4,p{
  text-align: center;
}
...
.card1 .span1,.card2 .span1,.card3 .span1{
  font-weight: bold;
}
.card2{
